...
EMSCRIPTEN_BINDINGS(Chafa) {
  ...
  emscripten::enum_<ChafaDitherMode>("ChafaDitherMode")
      ...
      .value("CHAFA_DITHER_MODE_NOISE", CHAFA_DITHER_MODE_NOISE)
  ...
  emscripten::enum_<ChafaSymbolTags>("ChafaSymbolTags")
      ...
      .value("CHAFA_SYMBOL_TAG_OCTANT", CHAFA_SYMBOL_TAG_OCTANT)
  ...
  emscripten::enum_<ChafaTermSeq>("ChafaTermSeq")
      ...
      .value("CHAFA_TERM_SEQ_QUERY_PRIMARY_DEVICE_ATTRIBUTES", CHAFA_TERM_SEQ_QUERY_PRIMARY_DEVICE_ATTRIBUTES)
      .value("CHAFA_TERM_SEQ_PRIMARY_DEVICE_ATTRIBUTES", CHAFA_TERM_SEQ_PRIMARY_DEVICE_ATTRIBUTES)
      .value("CHAFA_TERM_SEQ_QUERY_CELL_SIZE_PX", CHAFA_TERM_SEQ_QUERY_CELL_SIZE_PX)
      .value("CHAFA_TERM_SEQ_CELL_SIZE_PX", CHAFA_TERM_SEQ_CELL_SIZE_PX)
      .value("CHAFA_TERM_SEQ_QUERY_TEXT_AREA_SIZE_CELLS", CHAFA_TERM_SEQ_QUERY_TEXT_AREA_SIZE_CELLS)
      .value("CHAFA_TERM_SEQ_TEXT_AREA_SIZE_CELLS", CHAFA_TERM_SEQ_TEXT_AREA_SIZE_CELLS)
      .value("CHAFA_TERM_SEQ_QUERY_TEXT_AREA_SIZE_PX", CHAFA_TERM_SEQ_QUERY_TEXT_AREA_SIZE_PX)
      .value("CHAFA_TERM_SEQ_TEXT_AREA_SIZE_PX", CHAFA_TERM_SEQ_TEXT_AREA_SIZE_PX)
      ...
      .value("CHAFA_TERM_SEQ_QUERY_PRIMARY_DEVICE_ATTRIBUTES", CHAFA_TERM_SEQ_QUERY_PRIMARY_DEVICE_ATTRIBUTES)
      .value("CHAFA_TERM_SEQ_PRIMARY_DEVICE_ATTRIBUTES", CHAFA_TERM_SEQ_PRIMARY_DEVICE_ATTRIBUTES)
      .value("CHAFA_TERM_SEQ_BEGIN_HYPERLINK", CHAFA_TERM_SEQ_BEGIN_HYPERLINK)
      .value("CHAFA_TERM_SEQ_BEGIN_HYPERLINK_ANCHOR", CHAFA_TERM_SEQ_BEGIN_HYPERLINK_ANCHOR)
      .value("CHAFA_TERM_SEQ_END_HYPERLINK", CHAFA_TERM_SEQ_END_HYPERLINK)
      .value("CHAFA_TERM_SEQ_MAX", CHAFA_TERM_SEQ_MAX);
  emscripten::enum_<ChafaTermQuirks>("ChafaTermQuirks")
      .value("CHAFA_TERM_QUIRK_SIXEL_OVERSHOOT", CHAFA_TERM_QUIRK_SIXEL_OVERSHOOT);
